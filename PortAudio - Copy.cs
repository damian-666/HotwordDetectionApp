...
namespace HotwordDetectionApp
{
    ...
    private static PortAudio.PaStream _stream;
    ...
    public static void StartCapture(Action<float[]> onAudioCaptured)
    {
        ...
        PortAudio.Pa_OpenStream(out _stream, ref inputParameters, IntPtr.Zero, 16000, 256, PortAudio.PaStreamFlags.paClipOff, Callback, IntPtr.Zero);
